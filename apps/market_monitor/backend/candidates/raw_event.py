    ...
    def from_alert_payload(
        ...
        *,
        ...
        features = {
            ...
            "instrument_contract_type": payload.get("instrument_contract_type"),
            "instrument_underlying_type": payload.get("instrument_underlying_type"),
            "instrument_underlying_subtypes": list(payload.get("instrument_underlying_subtypes") or []),
